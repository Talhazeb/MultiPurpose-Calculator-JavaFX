...
public class area implements Initializable {
    ...
    public void openMainView() throws IOException {
        ...
        Stage Window = (Stage) areaBack.getScene().getWindow();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        comboT1.getItems().addAll("Meter^2", "Centimeter^2");
        comboT1.getSelectionModel().select("Meter^2");

        comboT2.getItems().clear();
        comboT2.getItems().addAll("Meter^2", "Centimeter^2");
        comboT2.getSelectionModel().select("Centimeter^2");
    }
    ...
    public void cal_convert() {
        ...
        double f, c;
        if (focus_t1) {
            if (comboT1.getValue().equals("Meter^2")) {
                f = digit_t1;

                if (comboT2.getValue().equals("Centimeter^2")) {
                    c = f*10000;
            ...
            } else if (comboT1.getValue().equals("Centimeter^2")) {
                c = digit_t1;

                if (comboT2.getValue().equals("Meter^2")) {
                    f = c/10000;
            ...
            if (comboT2.getValue().equals("Meter^2")) {
                ...
                if (comboT1.getValue().equals("Centimeter^2")) {
                    c = f*10000;
                    double roundOff = (double) Math.round(c * 100) / 100;
                    String temp = String.valueOf(roundOff);
                    lbl_t1.setText(temp);
            ...
            } else if (comboT2.getValue().equals("Centimeter^2")) {
                c = digit_t2;
