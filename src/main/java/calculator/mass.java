...
public class mass implements Initializable {
    ...
    public void openMainView() throws IOException {
        ...
        Stage Window = (Stage) massBack.getScene().getWindow();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        comboT1.getItems().addAll("kg", "g");
        comboT1.getSelectionModel().select("kg");

        comboT2.getItems().clear();
        comboT2.getItems().addAll("kg", "g");
        comboT2.getSelectionModel().select("g");
    }
    ...
    public void cal_convert() {
        ...
        double f, c;
        if (focus_t1) {
            if (comboT1.getValue().equals("kg")) {
                f = digit_t1;

                if (comboT2.getValue().equals("g")) {
                    c = f*1000;
                    double roundOff = (double) Math.round(c * 10000) / 10000;
            ...
            } else if (comboT1.getValue().equals("g")) {
                c = digit_t1;

                if (comboT2.getValue().equals("kg")) {
                    f = c/1000;
                    double roundOff = (double) Math.round(f * 10000) / 10000;
                    String temp = String.valueOf(roundOff);
                    lbl_t2.setText(temp);
                } else {
            ...
            } else if (comboT2.getValue().equals("g")) {
                c = digit_t2;
