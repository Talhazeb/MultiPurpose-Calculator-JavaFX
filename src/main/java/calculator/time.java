...
public class time implements Initializable {
    ...
    public void openMainView() throws IOException {
        ...
        Stage Window = (Stage) timeBack.getScene().getWindow();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        comboT1.getItems().addAll("min", "sec");
        comboT1.getSelectionModel().select("min");

        comboT2.getItems().clear();
        comboT2.getItems().addAll("min", "sec");
        comboT2.getSelectionModel().select("sec");
    }
    ...
    public void cal_convert() {
        ...
        double f, c;
        if (focus_t1) {
            if (comboT1.getValue().equals("min")) {
                f = digit_t1;

                if (comboT2.getValue().equals("sec")) {
                    c = f*60;
            ...
            } else if (comboT1.getValue().equals("sec")) {
                c = digit_t1;

                if (comboT2.getValue().equals("min")) {
                    f = c/60;
            ...
            if (comboT2.getValue().equals("min")) {
                ...
                if (comboT1.getValue().equals("sec")) {
                    c = f*60;
                    double roundOff = (double) Math.round(c * 100) / 100;
                    String temp = String.valueOf(roundOff);
                    lbl_t1.setText(temp);
            ...
            } else if (comboT2.getValue().equals("sec")) {
                c = digit_t2;
