...
public class temperature implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        comboT1.getItems().addAll("Fahrenheit", "Celsius");
        comboT1.getSelectionModel().select("Fahrenheit");

        comboT2.getItems().clear();
        comboT2.getItems().addAll("Fahrenheit", "Celsius");
        comboT2.getSelectionModel().select("Celsius");
    }
    ...
    public void cal_convert() {
        ...
        double f, c;
        if (focus_t1) {
            if (comboT1.getValue().equals("Fahrenheit")) {
                f = digit_t1;

                if (comboT2.getValue().equals("Celsius")) {
                    c = (f - 32) * 0.56;
            ...
            } else if (comboT1.getValue().equals("Celsius")) {
                c = digit_t1;

                if (comboT2.getValue().equals("Fahrenheit")) {
                    f = (c * 1.8) + 32;
            ...
            if (comboT2.getValue().equals("Fahrenheit")) {
                ...
                if (comboT1.getValue().equals("Celsius")) {
                    c = (f - 32) * 0.56;
                    double roundOff = (double) Math.round(c * 100) / 100;
                    String temp = String.valueOf(roundOff);
                    lbl_t1.setText(temp);
            ...
            } else if (comboT2.getValue().equals("Celsius")) {
                c = digit_t2;
