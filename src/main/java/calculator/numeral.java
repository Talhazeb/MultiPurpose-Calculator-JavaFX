...
public class numeral implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        comboT1.getItems().addAll("DEC", "BIN");
        comboT1.getSelectionModel().select("DEC");

        comboT2.getItems().clear();
        comboT2.getItems().addAll("DEC", "BIN");
        comboT2.getSelectionModel().select("BIN");
    }
    ...
    public void cal_convert() {
        ...
        double f, c;
        if (focus_t1) {
            if (comboT1.getValue().equals("DEC")) {
                f = digit_t1;

                if (comboT2.getValue().equals("BIN")) {
                    String tt2 = Integer.toBinaryString((int) f);
            ...
            } else if (comboT1.getValue().equals("BIN")) {
                c = digit_t1;

                if (comboT2.getValue().equals("DEC")) {
                    int tt1 = Integer.parseInt(singleString_t2,2);
                    //f = c/10000;
                    //double roundOff = (double) Math.round(f * 100) / 100;
                    String temp = String.valueOf(tt1);
                    lbl_t2.setText(temp);
                } else {
            ...
            if (comboT2.getValue().equals("DEC")) {
                ...
                if (comboT1.getValue().equals("BIN")) {
                    String tt2 = Integer.toBinaryString((int) f);
                    //double roundOff = (double) Math.round(c * 100) / 100;
                    //String temp = String.valueOf(roundOff);
                    lbl_t1.setText(tt2);
            ...
            } else if (comboT2.getValue().equals("BIN")) {
                c = digit_t2;
