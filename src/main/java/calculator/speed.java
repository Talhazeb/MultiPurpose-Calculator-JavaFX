...
public class speed implements Initializable {
    ...
    public void openMainView() throws IOException {
        ...
        Stage Window = (Stage) speedBack.getScene().getWindow();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        comboT1.getItems().addAll("m/s", "km/s");
        comboT1.getSelectionModel().select("m/s");

        comboT2.getItems().clear();
        comboT2.getItems().addAll("m/s", "km/s");
        comboT2.getSelectionModel().select("km/s");
    }
    ...
    public void cal_convert() {
        ...
        double f, c;
        if (focus_t1) {
            if (comboT1.getValue().equals("m/s")) {
                f = digit_t1;

                if (comboT2.getValue().equals("km/s")) {
                    c = f/1000;
            ...
            } else if (comboT1.getValue().equals("km/s")) {
                c = digit_t1;

                if (comboT2.getValue().equals("m/s")) {
                    f = c*1000;
            ...
            if (comboT2.getValue().equals("m/s")) {
                ...
                if (comboT1.getValue().equals("km/s")) {
                    c = f/1000;
                    double roundOff = (double) Math.round(c * 10000) / 10000;
                    String temp = String.valueOf(roundOff);
                    lbl_t1.setText(temp);
            ...
            } else if (comboT2.getValue().equals("km/s")) {
                c = digit_t2;
